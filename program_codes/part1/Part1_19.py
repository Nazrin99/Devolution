...
from program_codes.part1.util.functions import one_point_crossover
...
if __name__ == '__main__':
    result = genetic_algorithm(penalized_monkey_problem_fitness_function, POPULATION_SIZE, TARGET_PASSWORD, one_point_crossover)
