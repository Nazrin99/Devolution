...
from program_codes.part1.util.functions import two_point_crossover
...
if __name__ == '__main__':
    result = genetic_algorithm(monkey_problem_fitness_function, POPULATION_SIZE, TARGET_PASSWORD, two_point_crossover)
